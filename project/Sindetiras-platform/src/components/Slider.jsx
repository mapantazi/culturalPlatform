...
export const Slider = () => {
    ...
    const slides = [
        {   url: 'photos/slider/handmade.jpg',  titleKey: "slider.handmade" },
        {   url: 'photos/slider/shop.jpg',       titleKey: "slider.shop" },
        {   url: 'photos/slider/silver-ring.jpg', titleKey: "slider.silver-ring" },
        {   url: 'photos/slider/cross-silver.jpg', titleKey: "slider.cross-silver" }
      ];
